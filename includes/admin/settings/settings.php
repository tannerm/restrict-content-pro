					...
					<table class="form-table">
						...
						<tr valign="top">
							...
							<td>
								...
								<p class="description"><?php _e( 'This is the page the default login URL redirects to, if the option above is checked. This should be the page that contains the [login_form] short code.', 'rcp' ); ?></div>
							</td>
						</tr>
						<tr valign="top">
							<th>
						...
						<tr valign="top">
							...
							<td>
								...
								<p class="description"><?php _e( 'Choose the style you wish to use for your reCaptcha form', 'rcp' ); ?></div>
							</td>
						</tr>
					</table>
