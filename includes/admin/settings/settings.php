				...
				<div class="tab_content" id="emails">
					<div id="rcp_email_options">
						...
						<table class="form-table">
							...
							<tr valign="top">
								<th colspan=2><h3><?php _e( 'Email Verification', 'rcp' ); ?></h3></th>
							</tr>
							<tr valign="top">
								<th>
							...
							<tr valign="top"<?php echo ( ! isset( $rcp_options['email_verification'] ) || 'off' == $rcp_options['email_verification'] ) ? ' style="display: none;"' : ''; ?>>
								<th>
									<label for="rcp_settings[verification_subject]"><?php _e( 'Subject', 'rcp' ); ?></label>
								</th>
								<td>
							...
							<tr valign="top"<?php echo ( ! isset( $rcp_options['email_verification'] ) || 'off' == $rcp_options['email_verification'] ) ? ' style="display: none;"' : ''; ?>>
								<th>
									<label for="rcp_settings[verification_email]"><?php _e( 'Email Body', 'rcp' ); ?></label>
								</th>
								<td>
									<?php
