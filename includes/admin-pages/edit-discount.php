...
<h2>
	...
	<a href="<?php echo get_bloginfo('wpurl') . '/wp-admin/admin.php?page=rcp-discounts'; ?>" class="button-secondary">
		<?php _e('Cancel', 'rcp'); ?>
	</a>
</h2>
<form id="rcp-edit-discount" action="" method="post">
	<table class="form-table">
		<tbody>
			<tr class="form-field">
				...
				<td>
					<input name="name" id="rcp-name" type="text" value="<?php echo stripslashes($code->name); ?>"/>
			...
			<tr class="form-field">
				...
				<td>
					<textarea name="description" id="rcp-description"><?php echo stripslashes($code->description); ?></textarea>
			...
			<tr class="form-field">
				...
				<td>
					<input type="text" id="rcp-code" name="code" value="<?php echo $code->code; ?>" style="width: 300px;"/>
			...
			<tr class="form-field">
				...
				<td>
					<input type="text" id="rcp-amount" name="amount" value="<?php echo $code->amount; ?>" style="width: 40px;"/>
			...
			<tr valign="top">
				...
				<td>
					<input name="expiration" id="rcp-expiration" type="text" style="width: 120px;" class="datepicker" value="<?php echo $code->expiration == '' ? '' : date('Y-m-d', strtotime($code->expiration)); ?>"/>
			...
			<tr class="form-field">
				...
				<td>
					<input type="text" id="rcp-max-uses" name="max" value="<?php echo $code->max_uses; ?>" style="width: 40px;"/>
	...
	<p class="submit">
		...
		<input type="hidden" name="discount_id" value="<?php echo urldecode($_GET['edit_discount']); ?>"/>
