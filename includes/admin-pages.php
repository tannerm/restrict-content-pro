...
function rcp_settings_menu() {
	...
	// add settings page
	add_menu_page(__('Restrict Content Pro Settings', 'rcp'), __('Restrict', 'rcp'), 'manage_options', 'rcp-members', 'rcp_members_page',  plugin_dir_url( __FILE__ ) . 'images/lock.png');
